...
<style>
/* ==========================================================
   LIGHT GREY DASHBOARD — sidebar zgodny z makietą użytkownika
   ========================================================== */
...
/* usuń domyślne nadmiarowe marginesy */
...
/* Menu jako płaskie pozycje, aktywna na szarym tle */
...
.upload-icon { font-size: 44px; color: #64748B; margin-bottom: 8px; }
.upload-title { font-size: 15px; font-weight: 800; color: #0F172A; margin-bottom: 5px; }
...
""", unsafe_allow_html=True)
    ...
    # Navigation
    st.markdown("<p style='font-size:11px;font-weight:700;color:#4B5563;letter-spacing:1px;margin-bottom:6px;'>NAWIGACJA</p>", unsafe_allow_html=True)
    ...
    st.markdown("---")
    st.markdown("<p style='font-size:11px;font-weight:700;color:#4B5563;letter-spacing:1px;margin-bottom:6px;'>USTAWIENIA ANALIZY</p>", unsafe_allow_html=True)
    threshold = st.slider(
        "Próg odchylenia (%)",
...
<div class="sidebar-instruction">
  <p style="font-size:11px;font-weight:800;color:#4B5563;margin:0 0 12px 0;letter-spacing:.04em;">INSTRUKCJA</p>
